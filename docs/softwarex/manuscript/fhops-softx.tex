...
\usepackage{hyperref}
\urlstyle{tt}
\DeclareRobustCommand{\cpath}[1]{\path{#1}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{textcomp}
\usepackage{lineno}
...
\address[ubc]{Faculty of Forestry \& Environmental Stewardship, University of British Columbia, 2424 Main Mall, Office 4645, Vancouver, British Columbia, V6T 1Z4, Canada}
