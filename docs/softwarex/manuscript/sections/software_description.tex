...
\begin{itemize}
  ...
  \item MIP builder (\texttt{fhops.optimization.mip}) – shift-based Pyomo formulation with HiGHS backend for exact scheduling, informed by bilevel and multi-period harvest models \cite{paradis2018bilevel,nelson2003forestmodels}. Provides a comparable baseline when heuristics are insufficient.
