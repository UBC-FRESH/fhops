...
\begin{itemize}
  ...
  \item Workflow diagram – The workflow figure (Figure~\ref{fig:fhops-prisma-overview}) is expressed in TikZ so any FHOPS user can recompile it from the public repository, mirroring the approach used in FHOPS’ documentation set.
\end{itemize}
