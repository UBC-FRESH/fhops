...
\begin{itemize}
  ...
  \item Hooks for forthcoming BC validation datasets (community forests, skyline corridors, salvage plans) that remain private until their companion studies publish, ensuring the loader interfaces can ingest them without changes.
\end{itemize}
