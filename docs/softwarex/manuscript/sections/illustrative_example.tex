...
\begin{itemize}
  ...
  \item \textbf{Small21}: Provides the middle rung—the solver budgets carry over cleanly, and the heuristics produce objectives between $-120$ and $-90$ with runtimes under $30\,$s, showing the same operators scale as horizons grow.
