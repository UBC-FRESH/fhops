...
\item
  ...
  a turnkey tuning harness, and telemetry/playback tooling that all run
  through the same CLI pipeline. Every figure/table in the manuscript is
  regenerated from the scripts users run locally.
\item
