...
- ``fhops plan tactical-operational`` — solve the Phase 6 aggregate block × system × period MILP with continuous, semi-continuous, or whole-block harvest modes; supports cost, profit, and NPV objective profiles and exports objective decomposition, harvest decisions, production, transport flows, purchases, and facility inventory tables. See :doc:`../howto/tactical_operational`.
