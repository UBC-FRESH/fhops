...
- ``fhops plan tactical-operational`` — solve the Phase 6 aggregate block × system × period MILP with continuous, semi-continuous, or whole-block harvest modes; exports objective decomposition, harvest decisions, and product production tables. See :doc:`../howto/tactical_operational`.
