...
- ``fhops plan rolling`` — execute rolling-horizon solves (stub/SA/MIP hooks) with exports for per-iteration telemetry and locked assignments; see :doc:`../howto/rolling_horizon`.
