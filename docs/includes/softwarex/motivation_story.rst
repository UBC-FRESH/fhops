...
3. **Robust evaluation + extensibility.** FHOPS layers stochastic
   ...
   Those evaluation hooks also pave the way for forthcoming BC
   case-study validations (two–three tenures) that will reuse the
   platform documented here while reporting context-specific findings in
