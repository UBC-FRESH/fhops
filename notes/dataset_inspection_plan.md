  ...
  - ### Skyline action plan (refresh)
    ...
    - [ ] **Skyline costing defaults** – Build CPI-aware machine-rate entries for representative skyline yarders (Madill 009, Cypress 7280C, Skylead C40) plus rigging/crew assumptions, and thread them into `inspect-machine` / `--show-costs` / harvest-system overrides.
      ...
      - [ ] **FPInnovations skyline backlog (from reference log “Next Actions”)**
        - Cable Yarding (FNCY) + Advantage issues (ADV1N5, ADV5N28, ADV7N3, etc.) – *not yet started*. Need to mine these for swing/grapple yarder regressions to extend beyond the TN147/TN157/TR122 set.
        - November 2025 drop batching – *unstarted*. Still have to skim ADV1N12–ADV9N1 (Advantage wave), FNPC/FNSF issues (Field Notes), and TN123–TN296 + TR94/109/2017N34/2017N57/2021N93/2023N17 (Technical Notes/Reports) for skyline/forwarder data, then feed summaries back into `notes/reference_log.md` and this section.
