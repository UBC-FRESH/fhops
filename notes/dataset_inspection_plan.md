...
- [ ] **Grapple skidders & shovel loggers / hoe-chuckers (Han et al. 2018; George et al. 2022; FPInnovations skidder & shovel-logging series)**
  ...
  - [ ] Mine FPInnovations shovel logging studies (e.g., TR87, TR106, SR114) for additional cycle-time parameters (piece size, terrain factors) and integrate them as optional overrides/multipliers in the new helper.
