...
- [ ] **Skyline yarders / helicopter longline (Aubuchon 1982; Böhm & Kanzian 2023; Arnvik helicopter refs)**
  ...
  - ### Skyline action plan (refresh)
    ...
    - [ ] **Skyline wiring plan (no new refs)** – finish closing the loop with the datasets already in hand:
    ...
    - [ ] **Skyline data shopping list (FPInnovations Nov 2025 drop)** – new PDFs staged under `notes/reference/fpinnovations/` map to these outstanding needs:
        ...
        - **Partial-cut skyline penalties** – ADV11N17 (MPB partial cuts), ADV1N22 (Cariboo small openings), TN199 (Quadra Island second-growth partial cut), SR109 (coastal montane silviculture), and ADV9N4 (fuel-reduction thinning) all report falling/yarding/skidding productivities vs. retention intensity. Extract PMH + $/m³ tables to refine skyline/ground partial-cut multipliers beyond the current TR119 defaults.
