...
- **OpCost-style machine-rate dataset plan**
   ...
   - [ ] Layer in FPInnovations repair/maintenance survey (e.g., Advantage Vol. 4 No. 23: "Repair and maintenance costs of timber harvesting equipment") as optional coefficients so operating costs can be recomputed from utilization hours when users supply custom labour/fuel inputs. (Need access to the R&M report or equivalent numerics—SR85 doesn’t contain $ values.)
