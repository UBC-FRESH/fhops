...
- [ ] **Skyline yarders / helicopter longline (Aubuchon 1982; Böhm & Kanzian 2023; Arnvik helicopter refs)**
  ...
  - ### Skyline action plan (refresh)
    ...
    - [ ] **Add BC skyline presets** – Once coefficients are available, encode dedicated helpers (e.g., `tr112_cypress_grapple`, `tr127_blockX`) and expose block-specific predictor requirements (distance, slope, latd, latd2, stems/turn). Update docs/tests and retire the placeholder “not available” note.
