...
- Validated GeoJSON ingestion via the scenario loader (block/landing paths, CRS/id checks), refreshed fixtures/docs, and wired CLI usage into the data contract guidance.
