...
- Mocked heavy runtime dependencies (`pydantic`, `pyomo`, `pandas`, etc.) via `autodoc_mock_imports` so RTD autodoc renders module content without needing compiled wheels.
- Commands executed:
