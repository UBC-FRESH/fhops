...
- Documented the current simulated annealing defaults (temperature schedule, restarts, neighbourhoods) and cross-linked CLI/benchmark docs with tuning guidance to kick off the Phase 2 metaheuristic enhancements.
