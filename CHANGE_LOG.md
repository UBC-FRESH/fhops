...
- Added `fhops dataset unbc-hoe-chucking` as a reference command for the UNBC (Renzie 2006) hoe-chucking study, making the Table 33 shift summary (hours, volume, productivity, observed/weighted $/m³) available directly inside FHOPS for landing-processor budgeting.
