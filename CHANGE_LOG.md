...
- Added parametrised validation tests (`tests/test_contract_edge_cases.py`) to exercise edge-case scenarios across the data contract and introduced `tests/data/*` fixtures with loader coverage.
- Commands executed:
